...
namespace Day10AddressBook
{
    internal class AddMultBook
    {
        ...
        public static List<AddMultBook> ContactDetail = new List<AddMultBook>();
        public Dictionary<string, AddMultBook> AddBook;
        public static void AddBook6()
        {
            AddMultBook person = new AddMultBook();
